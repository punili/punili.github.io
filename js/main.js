$(document).ready(function(){
	...
	$(".wrap").hide();			
	setTimeout(function(){ 
		$(".img").css("animation","down 2s linear 1 forwards");    	
	},50);			
	$(".continueBtn").click(function(){			  	
    	...
    	$(".img").css("animation","");
	   	setTimeout(function(){
	   		$(".continueBtn").hide();
	   		$(".left").css("animation","left 2s linear 1 forwards");
	    	$(".right").css("animation","right 2s linear 1 forwards");
	   },500);			       
	    setTimeout(function(){$(".wrap").show()},1000);			    		    
	    setTimeout(function(){$(".sec1").animate({height:"0"},1500)},1200);			    
	    setTimeout(function(){
	    	$(".left").hide();
	    	$(".right").hide();
	    },2010);
	...
	$('.home').click(function(){				
		...
		$(".sec1").animate({height:"100vh"},1500);
		setTimeout(function(){$('html,body').css('paddingTop', 0);},600);								
		setTimeout(function(){
			$(".wrap").hide();
			$(".right").css("animation","right 2s linear 1 backwards reverse");
			$(".left").css("animation","left 2s linear 1 backwards reverse");
		},1450);
		setTimeout(function(){
			$(".right").show();
			$(".left").show();
		},1700);
		setTimeout(function(){$(".img").css("animation","down 2s linear 1 forwards");},3500);											 
		setTimeout(function(){$(".continueBtn").show()},3500);			 
	});
